...
colombia_municipios <- 
  colombia_municipios[!(colombia_municipios@data$NMG %in% c("PROVIDENCIA Y SANTA CATALINA (Santa Isabel)",
                                                                   "SAN ANDRÉS", "SANTA CATALINA") | colombia_municipios@data$COD_DANE_D == 88), ] %>%
